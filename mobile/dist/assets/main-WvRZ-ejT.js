const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B1POE996.js","assets/index-DjC3rGpM.js","assets/index-BJevg_d7.js","assets/index-Doah8fSD.js"])))=>i.map(i=>d[i]);
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(i){if(i.ep)return;i.ep=!0;const s=a(i);fetch(i.href,s)}})();const _="modulepreload",H=function(t){return"/"+t},k={},y=function(e,a,n){let i=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),c=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));i=Promise.allSettled(a.map(l=>{if(l=H(l),l in k)return;k[l]=!0;const g=l.endsWith(".css"),P=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${P}`))return;const u=document.createElement("link");if(u.rel=g?"stylesheet":_,g||(u.as="script"),u.crossOrigin="",u.href=l,c&&u.setAttribute("nonce",c),document.head.appendChild(u),g)return new Promise((M,A)=>{u.addEventListener("load",M),u.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${l}`)))})}))}function s(r){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=r,window.dispatchEvent(c),!c.defaultPrevented)throw r}return i.then(r=>{for(const c of r||[])c.status==="rejected"&&s(c.reason);return e().catch(s)})},$=localStorage.getItem("api_url")||"https://snobbily-civilisatory-denis.ngrok-free.dev";class z{constructor(){this.accessToken=null,this.refreshToken=null,this.loadTokens()}loadTokens(){this.accessToken=localStorage.getItem("access_token"),this.refreshToken=localStorage.getItem("refresh_token")}saveTokens(e,a){this.accessToken=e,this.refreshToken=a,localStorage.setItem("access_token",e),a&&localStorage.setItem("refresh_token",a)}clearTokens(){this.accessToken=null,this.refreshToken=null,localStorage.removeItem("access_token"),localStorage.removeItem("refresh_token"),localStorage.removeItem("user")}isAuthenticated(){return!!this.accessToken}async request(e,a={}){const n=`${$}${e}`,i={"Content-Type":"application/json","ngrok-skip-browser-warning":"true",...a.headers};this.accessToken&&(i.Authorization=`Bearer ${this.accessToken}`);try{let s=await fetch(n,{...a,headers:i});s.status===401&&this.refreshToken&&await this.refreshAccessToken()&&(i.Authorization=`Bearer ${this.accessToken}`,s=await fetch(n,{...a,headers:i}));const r=await s.json();if(!s.ok)throw new Error(r.error||"Request failed");return r}catch(s){throw console.error("API Error:",s),s}}async refreshAccessToken(){try{const e=await fetch(`${$}/api/v1/auth/refresh`,{method:"POST",headers:{Authorization:`Bearer ${this.refreshToken}`,"Content-Type":"application/json"}});if(e.ok){const a=await e.json();return this.saveTokens(a.access_token,this.refreshToken),!0}}catch(e){console.error("Token refresh failed:",e)}return this.clearTokens(),!1}async login(e,a){const n=await this.request("/api/v1/auth/login",{method:"POST",body:JSON.stringify({email:e,password:a})});return this.saveTokens(n.access_token,n.refresh_token),localStorage.setItem("user",JSON.stringify(n.user)),n}async register(e,a,n){const i=await this.request("/api/v1/auth/register",{method:"POST",body:JSON.stringify({name:e,email:a,password:n})});return this.saveTokens(i.access_token,i.refresh_token),localStorage.setItem("user",JSON.stringify(i.user)),i}async logout(){try{await this.request("/api/v1/auth/logout",{method:"POST"})}finally{this.clearTokens()}}async getMe(){return this.request("/api/v1/auth/me")}async getDashboard(){return this.request("/api/v1/dashboard")}async generateHealthSummary(){return this.request("/api/v1/health-summary/generate",{method:"POST"})}async getPrescriptions(e=1,a=10){return this.request(`/api/v1/prescriptions?page=${e}&per_page=${a}`)}async getPrescription(e){return this.request(`/api/v1/prescriptions/${e}`)}async uploadPrescription(e){return this.request("/api/v1/prescriptions",{method:"POST",body:JSON.stringify({image_base64:e})})}async uploadReport(e){return this.request("/api/v1/reports",{method:"POST",body:JSON.stringify({image:e})})}async deletePrescription(e){return this.request(`/api/v1/prescriptions/${e}`,{method:"DELETE"})}async getHealthReadings(){return this.request("/api/v1/health-readings")}async addHealthReading(e){return this.request("/api/v1/health-readings",{method:"POST",body:JSON.stringify(e)})}async deleteHealthReading(e){return this.request(`/api/v1/health-readings/${e}`,{method:"DELETE"})}async getTimeline(e=1,a=20,n="all"){return this.request(`/api/v1/timeline?page=${e}&per_page=${a}&filter=${n}`)}async sendChatMessage(e,a="en"){return this.request("/api/v1/chat",{method:"POST",body:JSON.stringify({message:e,language:a})})}async registerPushToken(e,a){return this.request("/api/v1/push-tokens",{method:"POST",body:JSON.stringify({token:e,platform:a})})}async getPharmaAssist(){return this.request("/api/v1/pharma-assist")}async compareMedicine(e){return this.request("/api/v1/pharma-assist/compare",{method:"POST",body:JSON.stringify({medicine_name:e})})}}const p=new z;let b,S,x,R,q;async function j(){try{const t=await y(()=>import("./index-B1POE996.js"),__vite__mapDeps([0,1]));b=t.Camera,S=t.CameraResultType,x=t.CameraSource}catch{console.log("Camera plugin not available (running in browser)")}try{R=(await y(()=>import("./index-BJevg_d7.js"),__vite__mapDeps([2,1]))).PushNotifications}catch{console.log("Push plugin not available")}try{q=(await y(()=>import("./index-Doah8fSD.js"),__vite__mapDeps([3,1]))).Preferences}catch{console.log("Preferences plugin not available")}}const m={currentPage:"dashboard",user:null,dashboardData:null,prescriptions:[],timelineEvents:[],isLoading:!1},o={app:null,loading:null,authContainer:null,mainContainer:null,mainContent:null,loginView:null,registerView:null,loginForm:null,registerForm:null,bottomNav:null,toastContainer:null};function N(){o.app=document.getElementById("app"),o.loading=document.getElementById("loading"),o.authContainer=document.getElementById("auth-container"),o.mainContainer=document.getElementById("main-container"),o.mainContent=document.getElementById("main-content"),o.loginView=document.getElementById("login-view"),o.registerView=document.getElementById("register-view"),o.loginForm=document.getElementById("login-form"),o.registerForm=document.getElementById("register-form"),o.bottomNav=document.querySelector(".bottom-nav"),o.toastContainer=document.getElementById("toast-container"),Object.entries(o).forEach(([t,e])=>{!e&&t!=="bottomNav"&&console.error(`Element not found: ${t}`)})}function d(t,e="info"){const a=document.createElement("div");a.className=`toast ${e}`,a.textContent=t,o.toastContainer.appendChild(a),setTimeout(()=>{a.style.animation="slideIn 0.3s ease reverse",setTimeout(()=>a.remove(),300)},3e3)}function v(t){m.currentPage=t,document.querySelectorAll(".nav-item").forEach(e=>{e.classList.toggle("active",e.dataset.page===t)}),D(t)}async function D(t){o.mainContent.style.animation="none",o.mainContent.offsetHeight,o.mainContent.style.animation="pageSlideIn 0.2s ease-out",o.mainContent.innerHTML='<div class="loading-screen"><div class="spinner"></div></div>';try{switch(t){case"dashboard":await T();break;case"scan":E();break;case"pharma":await O();break;case"timeline":await I();break;case"profile":F();break;default:await T()}}catch(e){d(e.message,"error")}}async function T(){app.currentPage="dashboard",document.querySelectorAll(".nav-item").forEach(s=>s.classList.remove("active"));const t=document.querySelector('.nav-item[data-page="dashboard"]');t&&t.classList.add("active");let e;try{e=await p.getDashboard()}catch(s){console.error("Dashboard API Error:",s),e={stats:{medicines:0,tests:0,prescriptions:0,reports:0},recent:[],todays_medication:[]}}m.dashboardData=e;const a=e.todays_medication||[],n={morning:a.filter(s=>(s.timing||"").toLowerCase().match(/morning|breakfast|am/)||!s.timing),afternoon:a.filter(s=>(s.timing||"").toLowerCase().match(/afternoon|lunch|day/)),night:a.filter(s=>(s.timing||"").toLowerCase().match(/night|dinner|bed|evening|pm/))},i=s=>!s||s.length===0?'<div class="med-dot" style="opacity: 0.3;"></div>':s.map(r=>`<div class="med-dot ${r.status==="taken","active"}" style="background: ${r.status==="taken"?"var(--color-neon-mint)":"var(--color-electric-cyan)"}"></div>`).join("");o.mainContent.innerHTML=`
        ...
        <div class="card animate-fade-in-up stagger-4">
            ...
            ${e.recent.length>0?e.recent.map(s=>{var r;return`
    ...
    `,document.getElementById("camera-btn").addEventListener("click",()=>f("camera")),document.getElementById("take-photo-btn").addEventListener("click",()=>f("camera")),document.getElementById("pick-photo-btn").addEventListener("click",()=>f("gallery")),document.getElementById("file-input").addEventListener("change",V)}async function f(t){if(b)try{const e=await b.getPhoto({quality:90,allowEditing:!0,resultType:S.Base64,source:t==="camera"?x.Camera:x.Photos});app.scanMode==="report"?await L(e.base64String):await B(e.base64String)}catch(e){e.message!=="User cancelled photos app"&&d("Camera error: "+e.message,"error")}else document.getElementById("file-input").click()}async function V(t){const e=t.target.files[0];if(!e)return;const a=new FileReader;a.onload=async n=>{const i=n.target.result.split(",")[1];app.scanMode==="report"?await L(i):await B(i)},a.readAsDataURL(e)}async function B(t){o.mainContent.innerHTML=`
            ...
            `;try{const e=await p.uploadPrescription(t);o.mainContent.innerHTML=`
            < div class="success-container" >
                <div class="success-icon">✅</div>
                <h2 class="success-title">Upload Successful!</h2>
                <p class="success-subtitle">Opening your prescription...</p>
            </div >
            `,setTimeout(()=>{e.id?app.viewPrescription(e.id):v("dashboard")},1500)}catch(e){o.mainContent.innerHTML=`
            ...
            `}}async function L(t){o.mainContent.innerHTML=`
            < div style = "display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh; text-align: center;" >
        ...
        `;try{const e=await p.uploadReport(t);o.mainContent.innerHTML=`
            < div style = "display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh; text-align: center;" >
        ...
        `,setTimeout(()=>{v("dashboard"),d("Report uploaded: "+e.summary.substring(0,30)+"...","success")},1500)}catch(e){o.mainContent.innerHTML=`
            < div style = "display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh; text-align: center;" >
                <div style="font-size: 80px;">❌</div>
            ...
            `;if(a.events.length===0){o.mainContent.innerHTML=`
        ...
        `;return}const i={};a.events.forEach(r=>{const l=(r.date?new Date(r.date):new Date).toLocaleDateString("en-US",{month:"long",year:"numeric"});i[l]||(i[l]=[]),i[l].push(r)});let s=`< h1 style = "margin-bottom: var(--space-md);" > Timeline</h1 > ${n} `;for(const[r,c]of Object.entries(i))s+=`
            < div class="timeline-section" >
                <div class="timeline-header">${r}</div>
                ${c.map(l=>`
            ...
            `;o.mainContent.innerHTML=s}async function O(){try{const t=await p.getPharmaAssist();let e=`
            ...
            `,o.mainContent.innerHTML=e,document.getElementById("pharma-search-form").addEventListener("submit",a=>{a.preventDefault();const n=document.getElementById("pharma-search-input").value.trim();n&&app.compareMedicine(n)})}catch(t){d("Failed to load medicines: "+t.message,"error"),v("dashboard")}}function F(){const t=m.user||JSON.parse(localStorage.getItem("user")||"{}"),e=(t.name||"U").split(" ").map(a=>a[0]).join("").toUpperCase();o.mainContent.innerHTML=`
        ...
        `}function U(){document.getElementById("show-register").addEventListener("click",t=>{t.preventDefault(),o.loginView.classList.add("hidden"),o.registerView.classList.remove("hidden")}),document.getElementById("show-login").addEventListener("click",t=>{t.preventDefault(),o.registerView.classList.add("hidden"),o.loginView.classList.remove("hidden")}),o.loginForm.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("login-email").value,a=document.getElementById("login-password").value;try{const n=o.loginForm.querySelector("button");n.disabled=!0,n.textContent="Logging in...";const i=await p.login(e,a);m.user=i.user,w(),d(`Welcome back, ${i.user.name} !`,"success")}catch(n){d(n.message,"error")}finally{const n=o.loginForm.querySelector("button");n.disabled=!1,n.textContent="Log In"}}),o.registerForm.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("register-name").value,a=document.getElementById("register-email").value,n=document.getElementById("register-password").value;try{const i=o.registerForm.querySelector("button");i.disabled=!0,i.textContent="Creating account...";const s=await p.register(e,a,n);m.user=s.user,w(),d("Account created successfully!","success")}catch(i){d(i.message,"error")}finally{const i=o.registerForm.querySelector("button");i.disabled=!1,i.textContent="Create Account"}})}function J(){o.bottomNav.querySelectorAll(".nav-item").forEach(t=>{t.addEventListener("click",e=>{e.preventDefault(),v(t.dataset.page)})})}function h(){o.loading&&o.loading.classList.add("hidden"),o.mainContainer&&o.mainContainer.classList.add("hidden"),o.authContainer&&o.authContainer.classList.remove("hidden")}function w(){o.loading&&o.loading.classList.add("hidden"),o.authContainer&&o.authContainer.classList.add("hidden"),o.mainContainer&&o.mainContainer.classList.remove("hidden"),v("dashboard")}window.app={viewPrescription:async t=>{var e;o.mainContent.innerHTML='<div class="loading-screen"><div class="spinner"></div></div>';try{const a=await p.getPrescription(t);let n=`
        ...
        `;t.readings&&t.readings.length>0?e+=t.readings.map(a=>`
            ...
            `,o.mainContent.innerHTML=e}catch(t){d("Failed to load vitals: "+t.message,"error"),v("dashboard")}},addVital:()=>{const t=`
            < div style = "margin-bottom: var(--space-md);" >
        ...
        `;o.mainContent.innerHTML=t,document.getElementById("vital-form").addEventListener("submit",async e=>{e.preventDefault();try{await p.addHealthReading({reading_type:document.getElementById("vital-type").value,value:document.getElementById("vital-value").value,unit:document.getElementById("vital-unit").value,notes:document.getElementById("vital-notes").value}),d("Reading saved!","success"),app.showVitals()}catch(a){d("Failed to save: "+a.message,"error")}})},deleteVital:async t=>{if(confirm("Delete this reading?"))try{await p.deleteHealthReading(t),d("Reading deleted","success"),app.showVitals()}catch(e){d("Delete failed: "+e.message,"error")}},showChat:()=>{let t=[];const e=()=>{let a=`
            < div style = "margin-bottom: var(--space-md);" >
                <button class="btn-secondary" onclick="app.goBack()" style="padding: 8px 16px;">
                    ← Back
                </button>
        ...
        `;o.mainContent.innerHTML=a,document.getElementById("chat-form").addEventListener("submit",async n=>{n.preventDefault();const i=document.getElementById("chat-input"),s=i.value.trim();if(!s)return;t.push({role:"user",content:s}),i.value="",e();const r=document.getElementById("chat-messages");r.innerHTML+='<div class="card" style="margin-right: 20%;"><div class="spinner" style="width: 24px; height: 24px;"></div></div>',r.scrollTop=r.scrollHeight;try{const c=await p.sendChatMessage(s);t.push({role:"assistant",content:c.response})}catch{t.push({role:"assistant",content:"Sorry, I encountered an error. Please try again."})}e(),document.getElementById("chat-messages").scrollTop=document.getElementById("chat-messages").scrollHeight})};e()},openSettings:()=>{const e=`
            < div style = "margin-bottom: var(--space-md);" >
                <button class="btn-secondary" onclick="app.goBack()" style="padding: 8px 16px;">
                    ← Back
                </button>
        ...
        `;o.mainContent.innerHTML=e,document.getElementById("notification-toggle").addEventListener("change",async a=>{const n=a.target.checked;localStorage.setItem("notifications_enabled",n),n&&"Notification"in window?await Notification.requestPermission()==="granted"?d("Notifications enabled!","success"):(a.target.checked=!1,localStorage.setItem("notifications_enabled","false"),d("Notification permission denied","error")):n||d("Notifications disabled","info")})},showServerConfig:()=>{const e=`
            < div style = "margin-bottom: var(--space-md);" >
        ...
        `;o.mainContent.innerHTML=e},saveServerUrl:()=>{const t=document.getElementById("server-url").value.trim();t&&(localStorage.setItem("api_url",t),d("Server URL saved. Reloading...","success"),setTimeout(()=>location.reload(),1500))},compareMedicine:async t=>{var e;o.mainContent.innerHTML='<div class="loading-screen"><div class="spinner"></div><p style="margin-top: 16px;">Finding alternatives...</p></div>';try{const a=await p.compareMedicine(t);let n=`
            < div style = "margin-bottom: var(--space-md);" >
